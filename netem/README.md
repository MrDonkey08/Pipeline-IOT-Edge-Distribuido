...
Este módulo contiene los scripts de simulación de condiciones de red adversas
utilizando `tc netem` (Traffic Control Network Emulator). Permite probar el
comportamiento del pipeline IoT/Edge bajo diferentes escenarios de degradación
de red, cumpliendo con los requisitos del Proyecto 2 de IL355.

Los scripts están diseñados para aplicarse sobre la interfaz de red especificada
y son completamente reversibles mediante el script `baseline.sh`.
